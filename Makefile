...
fastTest:
	# ===[ qMatrix ]==========================================================
	python3 qMatrix.py -i=patient_ids -i=id -o=- testDataSets/test_v1.csv -layer2=- -functions=-
	#
	# ===[ qMatrix via tree (original version) ]==============================
	python3 qMatrix.py -i=patient_ids -i=id -tree -o=- testDataSets/test_v1.csv -layer2=- -functions=-
	#
	# ===[ qMatrix via tree (fast version) ]==================================
	python3 qMatrix.py -i=patient_ids -i=id -tree-fast -o=- testDataSets/test_v1.csv -layer2=- -functions=-
